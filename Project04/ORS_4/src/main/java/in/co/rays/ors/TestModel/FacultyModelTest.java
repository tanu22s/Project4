...
public class FacultyModelTest {
	...
	public static void testAdd() throws DuplicateRecordException, ParseException {
		...
		try {
			...
			bean.setLoginId("aniv2@gmail.com");
			bean.setDateofjoining(sdf.parse("1/1/1992"));
			bean.setMobileno("8584545786");
			bean.setAddress("surya dev nagar");
			bean.setCollegeid(2);
	...
	public static void testFindByName() {
		...
		try {
			FacultyBean bean = model.findByEmail("gun34@gmail.com");
			if (bean == null) {
